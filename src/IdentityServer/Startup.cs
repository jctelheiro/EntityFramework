...
namespace IdentityServer
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            const string connectionString2 = @"Data Source=(LocalDb)\MSSQLLocalDB;database=IdentityTechCargo;trusted_connection=yes;";

            services.AddDbContext<ApplicationDbContext>(b =>
                b.UseSqlServer(connectionString2, sqlOptions => sqlOptions.MigrationsAssembly(migrationsAssembly)));
